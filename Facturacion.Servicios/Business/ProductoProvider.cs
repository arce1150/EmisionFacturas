        ...
        public override int InsertarProducto(ProductoBe p)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(_conexion))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter() { ParameterName = "@IdUnidad", SqlDbType = SqlDbType.VarChar, Value = (object)p.IdUnidad ?? DBNull.Value, Direction = ParameterDirection.Input, IsNullable = false });
